...
***Status: There are significant issues with the current PCB layout requiring a hardware hack (described below) - use of the current prototype layout is therefore not recommended***
